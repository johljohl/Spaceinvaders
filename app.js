document.addEventListener("DOMContentLoaded", () => {
  ...
  function shoot(e) {
      ...
      //move the laser fromm the shooter to the alien invader
      function moveLaser() {
          ...
          if(squares[currentLaserIndex].classlist.contains('invader')) {
              ...
              const alienInvadersTakeDown = alienInvaders.indexOf(currentLaserIndex)
      ...
      if(currentLaserIndex < width) {
          clearInterval(laserId)
          setTimeout(() => squares[currentLaserIndex].class.remove('laser'), 100)
      }
    }
